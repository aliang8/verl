    ...
    for generated_text, ground_truth, intermediate_truths in zip(generated_texts, ground_truths, intermediate_truths_list):
        ...
        if is_final_correct and is_format_valid and is_progressing:
            if reward_type == "all_or_none":
                r_intermediate = conditional_intermediate_reward_all_or_none(generated_text, ground_truth, intermediate_truths, base_reward)
            elif reward_type == "time_discounted":
                r_intermediate = conditional_intermediate_reward_time_discounted(generated_text, ground_truth, intermediate_truths, base_reward)
            else:
                r_intermediate = conditional_intermediate_reward_partial_credit(generated_text, ground_truth, intermediate_truths, base_reward)
        else:
            r_intermediate = 0.0
